    ...
    return (
      <div>
        ...
        <div className='row'>
          ...
          <div className='col-md-4 mb-4'><a target='_blank' rel='noopener noreferrer' href='http://t.me/konzski' className='btn btn-primary animate-down-2 d-block text-danger'><i className='fab fa-telegram mr-2'></i>Telegram</a></div>
        </div>
      </div>
    );
  }
